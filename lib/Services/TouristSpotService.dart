  ...
  static List<Map<String, dynamic>> getStaticSpots() {
    return [
      ...
      // Hunza Valley
      {
        ...
        'image': 'assets/images/tourist_spots/attabad_lake.jpeg',
        'category': 'Nature',
        'rating': '4.9',
        'reviews': 3200,
        'description':
      ...
      },
      {
        ...
        'location': 'Lahore, Pakistan',
        'image': 'assets/images/tourist_spots/minar_e_pakistan.jpeg',
        'category': 'Historical',
        'rating': '4.8',
        'reviews': 5000,
        'description':
            'National monument symbolizing the Lahore Resolution of 1940',
        'entryFee': 'Free',
        'distance': 'From Lahore Center: 2 km',
        'openTime': '8:00 AM - 10:00 PM',
        'isSaved': false,
      },
